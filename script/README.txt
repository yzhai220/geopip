...
4. indelible_test.py
   ...
   Note: this file should be used in pair with “control.txt”, which sets parameters for running INDELible.
   Different simulation setups can be used by changing BOTH the “control.txt” file and relevant parameters in the first part of the “indelible_test.py” file.
...
5. muscle_test.py
   ...
   Note: this file should be used in pair with “control.txt”, which sets parameters for running INDELible.
   Different simulation setups can be used by changing BOTH the “control.txt” file and relevant parameters in the first part of the “muscle_test.py” file.
